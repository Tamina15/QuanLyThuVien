...
public class ThemPNFRM extends javax.swing.JFrame {
    ...
    private void btnThemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThemMouseClicked
        ...
        if(txtMaNCC.getText().equals("") || txtTongtien.getText().equals("") || txtMaNV.getText().equals("") || (tblSachMoi.getRowCount()==0 && tblSachCu.getRowCount()==0)){
            ...
            if(tblSachCu.getRowCount()!=0){
                DauSachBUS sach = new DauSachBUS();
                ...
                for(int k=0;k<tblSachCu.getRowCount();k++){
                    ...
                    dausach.setMaDS(parseInt(mads));
                    dausach.setSoluong(soluong);
                    try {
                        sach.SuaSoluong(dausach);
                    } catch (Exception ex) {
                        Logger.getLogger(ThemPNFRM.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    //if(count!=0)
            ...
            PhieuNhapGUI.max=PhieuNhapGUI.max+1;
            dispose();
        }
