...
public class ChucVu_DSTinhTrangGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        if (tblCV.getColumnModel().getColumnCount() > 0) {
            tblCV.getColumnModel().getColumn(0).setMinWidth(100);
            tblCV.getColumnModel().getColumn(0).setPreferredWidth(100);
            tblCV.getColumnModel().getColumn(0).setMaxWidth(100);
        }
        ...
        if (tblTT.getColumnModel().getColumnCount() > 0) {
            tblTT.getColumnModel().getColumn(0).setMinWidth(100);
            tblTT.getColumnModel().getColumn(0).setPreferredWidth(100);
            tblTT.getColumnModel().getColumn(0).setMaxWidth(100);
        }
