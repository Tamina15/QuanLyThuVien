...
public class SachPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Tailai1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Tailai1ActionPerformed(evt);
            }
        });
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(lbMatacgia, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(10, 10, 10)
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        if(i>=0)
        {
            ...
            int check=0;
            txSoluong.setEnabled(true);
            if(Integer.parseInt(txSoluong.getText())!=0){
                check=1;
            }
            txSoluong.setEnabled(false);
            if(check==0){
    ...
    private void btXoa1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoa1ActionPerformed
        ...
        DauSachBUS sachbus = new DauSachBUS();
        DauSachDTO sach  = new DauSachDTO();
        sach.setMaDS(parseInt(txDausach.getText()));
        sach.setSoluong(-1);
            try {
                sachbus.SuaSoluong(sach);
            } catch (Exception ex) {
                Logger.getLogger(SachPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
        txDausach.setEnabled(false);
    ...
    private void Tailai1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Tailai1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Tailai1ActionPerformed
