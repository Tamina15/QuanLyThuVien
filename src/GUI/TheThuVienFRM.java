...
public class TheThuVienFRM extends javax.swing.JFrame {
    ...
    public TheThuVienFRM(int Ma) throws Exception {
        ...
        String dateHentra = formatter.format(cal.getTime());
        
        txtNgLam.setText(dateFormat);
        txtNgHan.setText(dateHentra);
        txtNgHan.setEnabled(false);
        txtNgLam.setEnabled(false);
    ...
    private void btnThemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThemMouseClicked
        ...
        txtNgHan.setEnabled(true);
        txtNgLam.setEnabled(true);
    ...
    private void btnXoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnXoaMouseClicked
        // TODO add your handling code here:
        if(choose!=-1){
            PhieuMuonBUS ktra= new PhieuMuonBUS();
            try {
                ktra.DocPM();
            } catch (Exception ex) {
                Logger.getLogger(TheThuVienFRM.class.getName()).log(Level.SEVERE, null, ex);
            ...
            int check=0;
            for(int j=0; j< PhieuMuonBUS.dspm.size(); j++){
                if(PhieuMuonBUS.dspm.get(j).getMatheTV()== Integer.parseInt (txtMaThe.getText())){
                    check=1;
                }
            }
            if(check==0){
                ...
                JOptionPane.showMessageDialog(null, "Không thể xóa thẻ thư viện này");
            }
        }
